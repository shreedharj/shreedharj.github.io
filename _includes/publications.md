...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 10px;">
    ...
    <div class="links">
      ...
      <button class="btn btn-sm z-depth-0 bibtex-toggle" role="button" style="font-size:12px;font-family:inherit;">BibTex</button>
      {% endif %}
      {% if link.notes %} 
    ...
    <div class="bibtex-container">
      <div class="bibtex-content hidden" data-bibtex="{{ link.bibtex_entry | escape }}">
        <pre style="margin: 0; padding: 10px; border-radius: 4px; font-size: 11px; overflow-x: auto;">{{ link.bibtex_entry }}</pre>
